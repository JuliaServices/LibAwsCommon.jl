...
function Base.getproperty(x::Ptr{pthread_cond_t}, f::Symbol)
    f === :__data && return Ptr{__JL_Ctag_1165}(x + 0)
...
function Base.getproperty(x::Ptr{pthread_rwlock_t}, f::Symbol)
    f === :__data && return Ptr{__JL_Ctag_1164}(x + 0)
...
struct __JL_Ctag_1207
    data::NTuple{8, UInt8}
end

function Base.getproperty(x::Ptr{__JL_Ctag_1207}, f::Symbol)
    f === :scheduled && return Ptr{Bool}(x + 0)
    f === :reserved && return Ptr{Csize_t}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::__JL_Ctag_1207, f::Symbol)
    r = Ref{__JL_Ctag_1207}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_1207}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_1207}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{aws_task}, f::Symbol)
    ...
    f === :abi_extension && return Ptr{__JL_Ctag_1207}(x + 56)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{__JL_Ctag_1164}, f::Symbol)
...
function Base.getproperty(x::__JL_Ctag_1164, f::Symbol)
    r = Ref{__JL_Ctag_1164}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_1164}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_1164}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{__JL_Ctag_1165}, f::Symbol)
    f === :__lock && return Ptr{Cint}(x + 0)
...
function Base.getproperty(x::__JL_Ctag_1165, f::Symbol)
    r = Ref{__JL_Ctag_1165}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_1165}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_1165}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end

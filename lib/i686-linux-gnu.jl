...
function Base.getproperty(x::Ptr{pthread_cond_t}, f::Symbol)
    f === :__data && return Ptr{__JL_Ctag_1205}(x + 0)
...
function Base.getproperty(x::Ptr{pthread_rwlock_t}, f::Symbol)
    f === :__data && return Ptr{__JL_Ctag_1210}(x + 0)
...
function Base.getproperty(x::Ptr{__JL_Ctag_1242}, f::Symbol)
    ...
    f === :_kill && return Ptr{__JL_Ctag_1243}(x + 0)
    f === :_timer && return Ptr{__JL_Ctag_1244}(x + 0)
    f === :_rt && return Ptr{__JL_Ctag_1245}(x + 0)
    f === :_sigchld && return Ptr{__JL_Ctag_1246}(x + 0)
    f === :_sigfault && return Ptr{__JL_Ctag_1247}(x + 0)
    f === :_sigpoll && return Ptr{__JL_Ctag_1248}(x + 0)
    f === :_sigsys && return Ptr{__JL_Ctag_1249}(x + 0)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{siginfo_t}, f::Symbol)
    ...
    f === :_sifields && return Ptr{__JL_Ctag_1242}(x + 12)
    return getfield(x, f)
end
...
"""
@cenum __JL_Ctag_876::UInt32 begin
...
function Base.getproperty(x::Ptr{aws_task}, f::Symbol)
    ...
    f === :abi_extension && return Ptr{__JL_Ctag_1250}(x + 32)
    return getfield(x, f)
end
...
"""
@cenum __JL_Ctag_1101::UInt32 begin
    AWS_UUID_STR_LEN = 37
end
...
function Base.getproperty(x::Ptr{__JL_Ctag_1205}, f::Symbol)
...
function Base.getproperty(x::__JL_Ctag_1205, f::Symbol)
    r = Ref{__JL_Ctag_1205}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_1205}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_1205}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{__JL_Ctag_1210}, f::Symbol)
    f === :__lock && return Ptr{Cint}(x + 0)
...
function Base.getproperty(x::__JL_Ctag_1210, f::Symbol)
    r = Ref{__JL_Ctag_1210}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_1210}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_1210}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{__JL_Ctag_1246}, f::Symbol)
    f === :si_pid && return Ptr{__pid_t}(x + 0)
    f === :si_uid && return Ptr{__uid_t}(x + 4)
...
function Base.getproperty(x::__JL_Ctag_1246, f::Symbol)
    r = Ref{__JL_Ctag_1246}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_1246}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_1246}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
Documentation not found.
"""
struct __JL_Ctag_1247
    si_addr::Ptr{Cvoid}
end
function Base.getproperty(x::Ptr{__JL_Ctag_1247}, f::Symbol)
    f === :si_addr && return Ptr{Ptr{Cvoid}}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::__JL_Ctag_1247, f::Symbol)
    r = Ref{__JL_Ctag_1247}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_1247}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_1247}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end

...
function Base.getproperty(x::Ptr{pthread_cond_t}, f::Symbol)
    f === :__data && return Ptr{__JL_Ctag_1149}(x + 0)
    f === :__size && return Ptr{NTuple{48, Cchar}}(x + 0)
    f === :__align && return Ptr{Clong}(x + 0)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{pthread_rwlock_t}, f::Symbol)
    f === :__data && return Ptr{__JL_Ctag_1147}(x + 0)
...
function Base.getproperty(x::Ptr{__JL_Ctag_1152}, f::Symbol)
    ...
    f === :_kill && return Ptr{__JL_Ctag_1153}(x + 0)
    f === :_timer && return Ptr{__JL_Ctag_1154}(x + 0)
    f === :_rt && return Ptr{__JL_Ctag_1155}(x + 0)
    f === :_sigchld && return Ptr{__JL_Ctag_1156}(x + 0)
    f === :_sigfault && return Ptr{__JL_Ctag_1157}(x + 0)
    f === :_sigpoll && return Ptr{__JL_Ctag_1158}(x + 0)
    f === :_sigsys && return Ptr{__JL_Ctag_1159}(x + 0)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{siginfo_t}, f::Symbol)
    ...
    f === :_sifields && return Ptr{__JL_Ctag_1152}(x + 16)
    return getfield(x, f)
end
...
struct __JL_Ctag_1193
    data::NTuple{8, UInt8}
end

function Base.getproperty(x::Ptr{__JL_Ctag_1193}, f::Symbol)
    f === :scheduled && return Ptr{Bool}(x + 0)
    f === :reserved && return Ptr{Csize_t}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::__JL_Ctag_1193, f::Symbol)
    r = Ref{__JL_Ctag_1193}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_1193}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_1193}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{aws_task}, f::Symbol)
    ...
    f === :abi_extension && return Ptr{__JL_Ctag_1193}(x + 56)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{__JL_Ctag_1147}, f::Symbol)
...
function Base.getproperty(x::__JL_Ctag_1147, f::Symbol)
    r = Ref{__JL_Ctag_1147}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_1147}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_1147}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct __JL_Ctag_1149
    __lock::Cint
    __futex::Cuint
...
function Base.getproperty(x::Ptr{__JL_Ctag_1149}, f::Symbol)
    f === :__lock && return Ptr{Cint}(x + 0)
...
function Base.getproperty(x::__JL_Ctag_1149, f::Symbol)
    r = Ref{__JL_Ctag_1149}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_1149}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_1149}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
struct __JL_Ctag_1159
    _call_addr::Ptr{Cvoid}
    _syscall::Cint
    _arch::Cuint
end
function Base.getproperty(x::Ptr{__JL_Ctag_1159}, f::Symbol)
...
function Base.getproperty(x::__JL_Ctag_1159, f::Symbol)
    r = Ref{__JL_Ctag_1159}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_1159}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_1159}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end

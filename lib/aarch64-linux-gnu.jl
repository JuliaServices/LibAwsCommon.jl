...
function Base.getproperty(x::Ptr{pthread_cond_t}, f::Symbol)
    f === :__data && return Ptr{__JL_Ctag_210}(x + 0)
    f === :__size && return Ptr{NTuple{48, Cchar}}(x + 0)
    f === :__align && return Ptr{Clong}(x + 0)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{pthread_rwlock_t}, f::Symbol)
    f === :__data && return Ptr{__JL_Ctag_212}(x + 0)
...
function Base.getproperty(x::Ptr{__JL_Ctag_202}, f::Symbol)
    ...
    f === :_kill && return Ptr{__JL_Ctag_203}(x + 0)
    f === :_timer && return Ptr{__JL_Ctag_204}(x + 0)
    f === :_rt && return Ptr{__JL_Ctag_205}(x + 0)
    f === :_sigchld && return Ptr{__JL_Ctag_206}(x + 0)
    f === :_sigfault && return Ptr{__JL_Ctag_207}(x + 0)
    f === :_sigpoll && return Ptr{__JL_Ctag_208}(x + 0)
    f === :_sigsys && return Ptr{__JL_Ctag_209}(x + 0)
    return getfield(x, f)
end
...
function Base.propertynames(x::__JL_Ctag_202, private::Bool = false)
...
function Base.getproperty(x::Ptr{siginfo_t}, f::Symbol)
    ...
    f === :_sifields && return Ptr{__JL_Ctag_202}(x + 16)
    return getfield(x, f)
end
...
function Base.propertynames(x::__JL_Ctag_211, private::Bool = false)
...
function Base.getproperty(x::Ptr{aws_task}, f::Symbol)
    ...
    f === :abi_extension && return Ptr{__JL_Ctag_211}(x + 56)
    return getfield(x, f)
end

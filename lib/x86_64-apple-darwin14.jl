...
function Base.getproperty(x::Ptr{aws_task}, f::Symbol)
    ...
    f === :abi_extension && return Ptr{var"union (unnamed at /home/runner/.julia/artifacts/442cfd5b8c0d9e10bd44be4da87c679f1eab0c5a/include/aws/common/task_scheduler.h:40:5)"}(x + 56)
    return getfield(x, f)
end

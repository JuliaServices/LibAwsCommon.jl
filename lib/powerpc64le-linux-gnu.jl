...
function Base.getproperty(x::Ptr{pthread_cond_t}, f::Symbol)
    f === :__data && return Ptr{__JL_Ctag_1208}(x + 0)
...
function Base.getproperty(x::Ptr{pthread_rwlock_t}, f::Symbol)
    f === :__data && return Ptr{__JL_Ctag_1213}(x + 0)
...
function Base.getproperty(x::Ptr{__JL_Ctag_1245}, f::Symbol)
    ...
    f === :_kill && return Ptr{__JL_Ctag_1246}(x + 0)
    f === :_timer && return Ptr{__JL_Ctag_1247}(x + 0)
    f === :_rt && return Ptr{__JL_Ctag_1248}(x + 0)
    f === :_sigchld && return Ptr{__JL_Ctag_1249}(x + 0)
    f === :_sigfault && return Ptr{__JL_Ctag_1250}(x + 0)
    f === :_sigpoll && return Ptr{__JL_Ctag_1251}(x + 0)
    f === :_sigsys && return Ptr{__JL_Ctag_1252}(x + 0)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{siginfo_t}, f::Symbol)
    ...
    f === :_sifields && return Ptr{__JL_Ctag_1245}(x + 16)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{aws_task}, f::Symbol)
    ...
    f === :abi_extension && return Ptr{__JL_Ctag_1253}(x + 56)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{__JL_Ctag_1208}, f::Symbol)
...
function Base.getproperty(x::__JL_Ctag_1208, f::Symbol)
    r = Ref{__JL_Ctag_1208}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_1208}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_1208}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end

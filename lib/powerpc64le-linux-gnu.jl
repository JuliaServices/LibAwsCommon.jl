...
function Base.getproperty(x::Ptr{pthread_cond_t}, f::Symbol)
    f === :__data && return Ptr{__JL_Ctag_1136}(x + 0)
...
function Base.getproperty(x::Ptr{pthread_rwlock_t}, f::Symbol)
    f === :__data && return Ptr{__JL_Ctag_1138}(x + 0)
...
function Base.getproperty(x::Ptr{__JL_Ctag_1146}, f::Symbol)
    ...
    f === :_kill && return Ptr{__JL_Ctag_1147}(x + 0)
    f === :_timer && return Ptr{__JL_Ctag_1148}(x + 0)
    f === :_rt && return Ptr{__JL_Ctag_1149}(x + 0)
    f === :_sigchld && return Ptr{__JL_Ctag_1150}(x + 0)
    f === :_sigfault && return Ptr{__JL_Ctag_1151}(x + 0)
    f === :_sigpoll && return Ptr{__JL_Ctag_1152}(x + 0)
    f === :_sigsys && return Ptr{__JL_Ctag_1153}(x + 0)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{siginfo_t}, f::Symbol)
    ...
    f === :_sifields && return Ptr{__JL_Ctag_1146}(x + 16)
    return getfield(x, f)
end
...
@cenum __JL_Ctag_256::UInt32 begin
...
@cenum __JL_Ctag_400::UInt32 begin
...
@cenum __JL_Ctag_612::UInt32 begin
...
@cenum __JL_Ctag_632::UInt32 begin
    AWS_CACHE_LINE = 64
end
...
function Base.getproperty(x::Ptr{aws_task}, f::Symbol)
    ...
    f === :abi_extension && return Ptr{__JL_Ctag_1177}(x + 56)
    return getfield(x, f)
end
...
@cenum __JL_Ctag_1029::UInt32 begin
    AWS_UUID_STR_LEN = 37
end
...
function Base.getproperty(x::Ptr{__JL_Ctag_1136}, f::Symbol)
...
function Base.getproperty(x::__JL_Ctag_1136, f::Symbol)
    r = Ref{__JL_Ctag_1136}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_1136}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_1136}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{__JL_Ctag_1138}, f::Symbol)
    f === :__lock && return Ptr{Cint}(x + 0)
...
function Base.getproperty(x::__JL_Ctag_1138, f::Symbol)
    r = Ref{__JL_Ctag_1138}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_1138}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_1138}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end

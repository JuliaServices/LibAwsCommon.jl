...
function Base.getproperty(x::Ptr{pthread_cond_t}, f::Symbol)
    f === :__data && return Ptr{__JL_Ctag_1148}(x + 0)
...
function Base.getproperty(x::Ptr{pthread_rwlock_t}, f::Symbol)
    f === :__data && return Ptr{__JL_Ctag_1146}(x + 0)
...
struct __JL_Ctag_1151
    data::NTuple{116, UInt8}
end

function Base.getproperty(x::Ptr{__JL_Ctag_1151}, f::Symbol)
    f === :_pad && return Ptr{NTuple{29, Cint}}(x + 0)
    f === :_kill && return Ptr{__JL_Ctag_1152}(x + 0)
    f === :_timer && return Ptr{__JL_Ctag_1153}(x + 0)
    f === :_rt && return Ptr{__JL_Ctag_1154}(x + 0)
    f === :_sigchld && return Ptr{__JL_Ctag_1155}(x + 0)
    f === :_sigfault && return Ptr{__JL_Ctag_1156}(x + 0)
    f === :_sigpoll && return Ptr{__JL_Ctag_1157}(x + 0)
    f === :_sigsys && return Ptr{__JL_Ctag_1158}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::__JL_Ctag_1151, f::Symbol)
    r = Ref{__JL_Ctag_1151}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_1151}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_1151}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{siginfo_t}, f::Symbol)
    ...
    f === :_sifields && return Ptr{__JL_Ctag_1151}(x + 12)
    return getfield(x, f)
end
...
@cenum __JL_Ctag_404::UInt32 begin
...
@cenum __JL_Ctag_620::UInt32 begin
...
@cenum __JL_Ctag_640::UInt32 begin
    AWS_CACHE_LINE = 64
end
...
@cenum __JL_Ctag_836::UInt32 begin
...
struct __JL_Ctag_1192
    data::NTuple{4, UInt8}
end

function Base.getproperty(x::Ptr{__JL_Ctag_1192}, f::Symbol)
    f === :scheduled && return Ptr{Bool}(x + 0)
    f === :reserved && return Ptr{Csize_t}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::__JL_Ctag_1192, f::Symbol)
    r = Ref{__JL_Ctag_1192}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_1192}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_1192}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{aws_task}, f::Symbol)
    ...
    f === :abi_extension && return Ptr{__JL_Ctag_1192}(x + 32)
    return getfield(x, f)
end
...
@cenum __JL_Ctag_1040::UInt32 begin
    AWS_UUID_STR_LEN = 37
end
...
function Base.getproperty(x::Ptr{___itt_domain}, f::Symbol)
    ...
    f === :nameA && return Ptr{Ptr{Cchar}}(x + 4)
    f === :nameW && return Ptr{Ptr{Cvoid}}(x + 8)
    f === :extra1 && return Ptr{Cint}(x + 12)
    f === :extra2 && return Ptr{Ptr{Cvoid}}(x + 16)
    f === :next && return Ptr{Ptr{___itt_domain}}(x + 20)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{___itt_string_handle}, f::Symbol)
    ...
    f === :strW && return Ptr{Ptr{Cvoid}}(x + 4)
    f === :extra1 && return Ptr{Cint}(x + 8)
    f === :extra2 && return Ptr{Ptr{Cvoid}}(x + 12)
    f === :next && return Ptr{Ptr{___itt_string_handle}}(x + 16)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{___itt_clock_domain}, f::Symbol)
    ...
    f === :fn_data && return Ptr{Ptr{Cvoid}}(x + 20)
    f === :extra1 && return Ptr{Cint}(x + 24)
    f === :extra2 && return Ptr{Ptr{Cvoid}}(x + 28)
    f === :next && return Ptr{Ptr{___itt_clock_domain}}(x + 32)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{___itt_track}, f::Symbol)
    ...
    f === :group && return Ptr{Ptr{__itt_track_group}}(x + 4)
    f === :ttype && return Ptr{__itt_track_type}(x + 8)
    f === :extra1 && return Ptr{Cint}(x + 12)
    f === :extra2 && return Ptr{Ptr{Cvoid}}(x + 16)
    f === :next && return Ptr{Ptr{___itt_track}}(x + 20)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{___itt_track_group}, f::Symbol)
    f === :name && return Ptr{Ptr{__itt_string_handle}}(x + 0)
    f === :track && return Ptr{Ptr{___itt_track}}(x + 4)
    f === :tgtype && return Ptr{__itt_track_group_type}(x + 8)
    f === :extra1 && return Ptr{Cint}(x + 12)
    f === :extra2 && return Ptr{Ptr{Cvoid}}(x + 16)
    f === :next && return Ptr{Ptr{___itt_track_group}}(x + 20)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{___itt_section_info}, f::Symbol)
    ...
    f === :type && return Ptr{__itt_section_type}(x + 4)
    f === :flags && return Ptr{Csize_t}(x + 8)
    f === :start_addr && return Ptr{Ptr{Cvoid}}(x + 12)
    f === :size && return Ptr{Csize_t}(x + 16)
    f === :file_offset && return Ptr{Csize_t}(x + 20)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{___itt_module_object}, f::Symbol)
    ...
    f === :module_name && return Ptr{Ptr{Cchar}}(x + 36)
    f === :module_buffer && return Ptr{Ptr{Cvoid}}(x + 40)
    f === :module_size && return Ptr{Csize_t}(x + 44)
    f === :section_array && return Ptr{Ptr{__itt_section_info}}(x + 48)
    f === :section_number && return Ptr{Csize_t}(x + 52)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{___itt_histogram}, f::Symbol)
    ...
    f === :nameA && return Ptr{Ptr{Cchar}}(x + 4)
    f === :nameW && return Ptr{Ptr{Cvoid}}(x + 8)
    f === :x_type && return Ptr{__itt_metadata_type}(x + 12)
    f === :y_type && return Ptr{__itt_metadata_type}(x + 16)
    f === :extra1 && return Ptr{Cint}(x + 20)
    f === :extra2 && return Ptr{Ptr{Cvoid}}(x + 24)
    f === :next && return Ptr{Ptr{___itt_histogram}}(x + 28)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{___itt_context_metadata}, f::Symbol)
    ...
    f === :value && return Ptr{Ptr{Cvoid}}(x + 4)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{___itt_counter_metadata}, f::Symbol)
    ...
    f === :type && return Ptr{__itt_context_type}(x + 4)
    f === :str_valueA && return Ptr{Ptr{Cchar}}(x + 8)
    f === :str_valueW && return Ptr{Ptr{Cvoid}}(x + 12)
    f === :value && return Ptr{Culonglong}(x + 16)
    f === :extra1 && return Ptr{Cint}(x + 24)
    f === :extra2 && return Ptr{Ptr{Cvoid}}(x + 28)
    f === :next && return Ptr{Ptr{___itt_counter_metadata}}(x + 32)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{__JL_Ctag_1146}, f::Symbol)
    f === :__lock && return Ptr{Cint}(x + 0)
...
function Base.getproperty(x::__JL_Ctag_1146, f::Symbol)
    r = Ref{__JL_Ctag_1146}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_1146}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_1146}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct __JL_Ctag_1148
    __lock::Cint
    __futex::Cuint
...
function Base.getproperty(x::Ptr{__JL_Ctag_1148}, f::Symbol)
    f === :__lock && return Ptr{Cint}(x + 0)
...
function Base.getproperty(x::__JL_Ctag_1148, f::Symbol)
    r = Ref{__JL_Ctag_1148}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_1148}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_1148}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct __JL_Ctag_1152
    si_pid::__pid_t
    si_uid::__uid_t
end
function Base.getproperty(x::Ptr{__JL_Ctag_1152}, f::Symbol)
    f === :si_pid && return Ptr{__pid_t}(x + 0)
    f === :si_uid && return Ptr{__uid_t}(x + 4)
    return getfield(x, f)
end

function Base.getproperty(x::__JL_Ctag_1152, f::Symbol)
    r = Ref{__JL_Ctag_1152}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_1152}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_1152}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct __JL_Ctag_1153
    si_tid::Cint
    si_overrun::Cint
    si_sigval::sigval_t
end
function Base.getproperty(x::Ptr{__JL_Ctag_1153}, f::Symbol)
...
function Base.getproperty(x::__JL_Ctag_1153, f::Symbol)
    r = Ref{__JL_Ctag_1153}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_1153}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_1153}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct __JL_Ctag_1154
    si_pid::__pid_t
    si_uid::__uid_t
    si_sigval::sigval_t
end
function Base.getproperty(x::Ptr{__JL_Ctag_1154}, f::Symbol)
    f === :si_pid && return Ptr{__pid_t}(x + 0)
    f === :si_uid && return Ptr{__uid_t}(x + 4)
    f === :si_sigval && return Ptr{sigval_t}(x + 8)
    return getfield(x, f)
...
function Base.getproperty(x::__JL_Ctag_1154, f::Symbol)
    r = Ref{__JL_Ctag_1154}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_1154}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_1154}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct __JL_Ctag_1155
    si_pid::__pid_t
    si_uid::__uid_t
    si_status::Cint
    si_utime::__clock_t
...
function Base.getproperty(x::Ptr{__JL_Ctag_1155}, f::Symbol)
    f === :si_pid && return Ptr{__pid_t}(x + 0)
    f === :si_uid && return Ptr{__uid_t}(x + 4)
...
function Base.getproperty(x::__JL_Ctag_1155, f::Symbol)
    r = Ref{__JL_Ctag_1155}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_1155}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_1155}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct __JL_Ctag_1156
    si_addr::Ptr{Cvoid}
    si_addr_lsb::Cshort
end
function Base.getproperty(x::Ptr{__JL_Ctag_1156}, f::Symbol)
    f === :si_addr && return Ptr{Ptr{Cvoid}}(x + 0)
    f === :si_addr_lsb && return Ptr{Cshort}(x + 4)
    return getfield(x, f)
end

function Base.getproperty(x::__JL_Ctag_1156, f::Symbol)
    r = Ref{__JL_Ctag_1156}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_1156}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_1156}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct __JL_Ctag_1157
    si_band::Clong
    si_fd::Cint
end
function Base.getproperty(x::Ptr{__JL_Ctag_1157}, f::Symbol)
    f === :si_band && return Ptr{Clong}(x + 0)
    f === :si_fd && return Ptr{Cint}(x + 4)
    return getfield(x, f)
end

function Base.getproperty(x::__JL_Ctag_1157, f::Symbol)
    r = Ref{__JL_Ctag_1157}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_1157}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_1157}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct __JL_Ctag_1158
    _call_addr::Ptr{Cvoid}
    _syscall::Cint
    _arch::Cuint
end
function Base.getproperty(x::Ptr{__JL_Ctag_1158}, f::Symbol)
...
function Base.getproperty(x::__JL_Ctag_1158, f::Symbol)
    r = Ref{__JL_Ctag_1158}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_1158}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_1158}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
const ITT_PLATFORM = ITT_PLATFORM_POSIX

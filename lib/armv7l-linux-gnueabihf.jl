...
function Base.getproperty(x::Ptr{pthread_cond_t}, f::Symbol)
    f === :__data && return Ptr{__JL_Ctag_1221}(x + 0)
...
Documentation not found.
"""
struct __JL_Ctag_1298
    data::NTuple{116, UInt8}
end

function Base.getproperty(x::Ptr{__JL_Ctag_1298}, f::Symbol)
    f === :_pad && return Ptr{NTuple{29, Cint}}(x + 0)
    f === :_kill && return Ptr{__JL_Ctag_1299}(x + 0)
    f === :_timer && return Ptr{__JL_Ctag_1300}(x + 0)
    f === :_rt && return Ptr{__JL_Ctag_1301}(x + 0)
    f === :_sigchld && return Ptr{__JL_Ctag_1302}(x + 0)
    f === :_sigfault && return Ptr{__JL_Ctag_1303}(x + 0)
    f === :_sigpoll && return Ptr{__JL_Ctag_1304}(x + 0)
    f === :_sigsys && return Ptr{__JL_Ctag_1305}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::__JL_Ctag_1298, f::Symbol)
    r = Ref{__JL_Ctag_1298}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_1298}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_1298}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{siginfo_t}, f::Symbol)
    ...
    f === :_sifields && return Ptr{__JL_Ctag_1298}(x + 12)
    return getfield(x, f)
end
...
"""
struct __JL_Ctag_1265
    data::NTuple{4, UInt8}
end

function Base.getproperty(x::Ptr{__JL_Ctag_1265}, f::Symbol)
    f === :scheduled && return Ptr{Bool}(x + 0)
    f === :reserved && return Ptr{Csize_t}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::__JL_Ctag_1265, f::Symbol)
    r = Ref{__JL_Ctag_1265}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_1265}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_1265}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{aws_task}, f::Symbol)
    ...
    f === :abi_extension && return Ptr{__JL_Ctag_1265}(x + 32)
    return getfield(x, f)
end

...
@cenum __JL_Ctag_193::UInt32 begin
...
@cenum __JL_Ctag_265::UInt32 begin
...
struct __JL_Ctag_465
    data::NTuple{8, UInt8}
end

function Base.getproperty(x::Ptr{__JL_Ctag_465}, f::Symbol)
    f === :scheduled && return Ptr{Bool}(x + 0)
    f === :reserved && return Ptr{Csize_t}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::__JL_Ctag_465, f::Symbol)
    r = Ref{__JL_Ctag_465}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_465}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_465}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{aws_task}, f::Symbol)
    ...
    f === :abi_extension && return Ptr{__JL_Ctag_465}(x + 56)
    return getfield(x, f)
end
...
const __itt_pt_region_createA_ptr__3_0_t = Ptr{Cvoid}

# ITT_STUB ( ITTAPI , __itt_pt_region , pt_region_createW , ( const wchar_t * name ) )
const __itt_pt_region_createW_ptr__3_0_t = Ptr{Cvoid}
...
const __itt_thread_set_nameA_ptr__3_0_t = Ptr{Cvoid}

# ITT_STUBV ( ITTAPI , void , thread_set_nameW , ( const wchar_t * name ) )
const __itt_thread_set_nameW_ptr__3_0_t = Ptr{Cvoid}
...
const __itt_model_site_beginW_ptr__3_0_t = Ptr{Cvoid}
...
const __itt_model_task_beginW_ptr__3_0_t = Ptr{Cvoid}

# ITT_STUBV ( ITTAPI , void , model_iteration_taskW , ( const wchar_t * name ) )
const __itt_model_iteration_taskW_ptr__3_0_t = Ptr{Cvoid}
...
const __itt_heap_function_createA_ptr__3_0_t = Ptr{Cvoid}

# ITT_STUB ( ITTAPI , __itt_heap_function , heap_function_createW , ( const wchar_t * name , const wchar_t * domain ) )
const __itt_heap_function_createW_ptr__3_0_t = Ptr{Cvoid}
...
const __itt_domain_createA_ptr__3_0_t = Ptr{Cvoid}

# ITT_STUB ( ITTAPI , __itt_domain * , domain_createW , ( const wchar_t * name ) )
const __itt_domain_createW_ptr__3_0_t = Ptr{Cvoid}
...
const __itt_string_handle_createA_ptr__3_0_t = Ptr{Cvoid}

# ITT_STUB ( ITTAPI , __itt_string_handle * , string_handle_createW , ( const wchar_t * name ) )
const __itt_string_handle_createW_ptr__3_0_t = Ptr{Cvoid}
...
const __itt_metadata_str_addA_ptr__3_0_t = Ptr{Cvoid}
...
const __itt_metadata_str_addW_ptr__3_0_t = Ptr{Cvoid}
...
const __itt_metadata_str_add_with_scopeA_ptr__3_0_t = Ptr{Cvoid}
...
const __itt_metadata_str_add_with_scopeW_ptr__3_0_t = Ptr{Cvoid}
...
# typedef void ( ITTAPI * __itt_get_clock_info_fn
"""
` exclude_from_documentation `
"""
...
const __itt_counter_createA_ptr__3_0_t = Ptr{Cvoid}

# ITT_STUB ( ITTAPI , __itt_counter , counter_createW , ( const wchar_t * name , const wchar_t * domain ) )
const __itt_counter_createW_ptr__3_0_t = Ptr{Cvoid}
...
const __itt_event_createA_ptr__3_0_t = Ptr{Cvoid}

# ITT_STUB ( LIBITTAPI , __itt_event , event_createW , ( const wchar_t * name , int namelen ) )
const __itt_event_createW_ptr__3_0_t = Ptr{Cvoid}
...
const __itt_module_loadA_ptr__3_0_t = Ptr{Cvoid}

# ITT_STUB ( ITTAPI , void , module_loadW , ( void * start_addr , void * end_addr , const wchar_t * path ) )
const __itt_module_loadW_ptr__3_0_t = Ptr{Cvoid}
...
const __itt_histogram_createA_ptr__3_0_t = Ptr{Cvoid}
...
const __itt_histogram_createW_ptr__3_0_t = Ptr{Cvoid}
...
const ITT_PLATFORM = ITT_PLATFORM_WIN
...
const __itt_pt_region_createA = ITTNOTIFY_DATA(pt_region_createA)

const __itt_pt_region_create = __itt_pt_region_createA

const __itt_pt_region_createA_ptr = ITTNOTIFY_NAME(pt_region_createA)

const __itt_pt_region_createW = ITTNOTIFY_DATA(pt_region_createW)

const __itt_pt_region_createW_ptr = ITTNOTIFY_NAME(pt_region_createW)

const __itt_thread_set_nameA = ITTNOTIFY_VOID(thread_set_nameA)

const __itt_thread_set_name = __itt_thread_set_nameA

const __itt_thread_set_nameA_ptr = ITTNOTIFY_NAME(thread_set_nameA)

const __itt_thread_set_name_ptr = __itt_thread_set_nameA_ptr

const __itt_thread_set_nameW = ITTNOTIFY_VOID(thread_set_nameW)

const __itt_thread_set_nameW_ptr = ITTNOTIFY_NAME(thread_set_nameW)
...
const __itt_sync_createA = ITTNOTIFY_VOID(sync_createA)

const __itt_sync_create = __itt_sync_createA

const __itt_sync_createA_ptr = ITTNOTIFY_NAME(sync_createA)

const __itt_sync_create_ptr = __itt_sync_createA_ptr

const __itt_sync_createW = ITTNOTIFY_VOID(sync_createW)

const __itt_sync_createW_ptr = ITTNOTIFY_NAME(sync_createW)

const __itt_sync_renameA = ITTNOTIFY_VOID(sync_renameA)

const __itt_sync_rename = __itt_sync_renameA

const __itt_sync_renameA_ptr = ITTNOTIFY_NAME(sync_renameA)

const __itt_sync_rename_ptr = __itt_sync_renameA_ptr

const __itt_sync_renameW = ITTNOTIFY_VOID(sync_renameW)

const __itt_sync_renameW_ptr = ITTNOTIFY_NAME(sync_renameW)
...
const __itt_model_site_beginW = ITTNOTIFY_VOID(model_site_beginW)

const __itt_model_site_beginW_ptr = ITTNOTIFY_NAME(model_site_beginW)
...
const __itt_model_task_beginW = ITTNOTIFY_VOID(model_task_beginW)

const __itt_model_task_beginW_ptr = ITTNOTIFY_NAME(model_task_beginW)

const __itt_model_iteration_taskW = ITTNOTIFY_VOID(model_iteration_taskW)

const __itt_model_iteration_taskW_ptr = ITTNOTIFY_NAME(model_iteration_taskW)
...
const __itt_heap_function_createA = ITTNOTIFY_DATA(heap_function_createA)

const __itt_heap_function_create = __itt_heap_function_createA

const __itt_heap_function_createA_ptr = ITTNOTIFY_NAME(heap_function_createA)

const __itt_heap_function_create_ptr = __itt_heap_function_createA_ptr

const __itt_heap_function_createW = ITTNOTIFY_DATA(heap_function_createW)

const __itt_heap_function_createW_ptr = ITTNOTIFY_NAME(heap_function_createW)
...
const __itt_domain_createA = ITTNOTIFY_DATA(domain_createA)

const __itt_domain_create = __itt_domain_createA

const __itt_domain_createA_ptr = ITTNOTIFY_NAME(domain_createA)

const __itt_domain_create_ptr = __itt_domain_createA_ptr

const __itt_domain_createW = ITTNOTIFY_DATA(domain_createW)

const __itt_domain_createW_ptr = ITTNOTIFY_NAME(domain_createW)

const __itt_id_create_ptr = ITTNOTIFY_NAME(id_create)

const __itt_id_destroy_ptr = ITTNOTIFY_NAME(id_destroy)

const __itt_string_handle_createA = ITTNOTIFY_DATA(string_handle_createA)

const __itt_string_handle_create = __itt_string_handle_createA

const __itt_string_handle_createA_ptr = ITTNOTIFY_NAME(string_handle_createA)

const __itt_string_handle_create_ptr = __itt_string_handle_createA_ptr

const __itt_string_handle_createW = ITTNOTIFY_DATA(string_handle_createW)

const __itt_string_handle_createW_ptr = ITTNOTIFY_NAME(string_handle_createW)
...
const __itt_metadata_str_add = __itt_metadata_str_addA

const __itt_metadata_str_addA_ptr = ITTNOTIFY_NAME(metadata_str_addA)

const __itt_metadata_str_add_ptr = __itt_metadata_str_addA_ptr

const __itt_metadata_str_addW_ptr = ITTNOTIFY_NAME(metadata_str_addW)

const __itt_metadata_add_with_scope_ptr = ITTNOTIFY_NAME(metadata_add_with_scope)

const __itt_metadata_str_add_with_scope = __itt_metadata_str_add_with_scopeA

const __itt_metadata_str_add_with_scopeA_ptr = ITTNOTIFY_NAME(metadata_str_add_with_scopeA)

const __itt_metadata_str_add_with_scope_ptr = __itt_metadata_str_add_with_scopeA_ptr

const __itt_metadata_str_add_with_scopeW_ptr = ITTNOTIFY_NAME(metadata_str_add_with_scopeW)
...
const __itt_counter_createA = ITTNOTIFY_DATA(counter_createA)

const __itt_counter_create = __itt_counter_createA

const __itt_counter_createA_ptr = ITTNOTIFY_NAME(counter_createA)

const __itt_counter_create_ptr = __itt_counter_createA_ptr

const __itt_counter_createW = ITTNOTIFY_DATA(counter_createW)

const __itt_counter_createW_ptr = ITTNOTIFY_NAME(counter_createW)
...
const __itt_counter_create_typedA = ITTNOTIFY_DATA(counter_create_typedA)

const __itt_counter_create_typed = __itt_counter_create_typedA

const __itt_counter_create_typedA_ptr = ITTNOTIFY_NAME(counter_create_typedA)

const __itt_counter_create_typed_ptr = __itt_counter_create_typedA_ptr

const __itt_counter_create_typedW = ITTNOTIFY_DATA(counter_create_typedW)

const __itt_counter_create_typedW_ptr = ITTNOTIFY_NAME(counter_create_typedW)
...
const __itt_event_createA = ITTNOTIFY_DATA(event_createA)

const __itt_event_create = __itt_event_createA

const __itt_event_createA_ptr = ITTNOTIFY_NAME(event_createA)

const __itt_event_create_ptr = __itt_event_createA_ptr

const __itt_event_createW = ITTNOTIFY_DATA(event_createW)

const __itt_event_createW_ptr = ITTNOTIFY_NAME(event_createW)
...
const __itt_av_saveA = ITTNOTIFY_DATA(av_saveA)

const __itt_av_save = __itt_av_saveA

const __itt_av_saveA_ptr = ITTNOTIFY_NAME(av_saveA)

const __itt_av_save_ptr = __itt_av_saveA_ptr

const __itt_av_saveW = ITTNOTIFY_DATA(av_saveW)

const __itt_av_saveW_ptr = ITTNOTIFY_NAME(av_saveW)

const __itt_enable_attach = ITTNOTIFY_VOID(enable_attach)

const __itt_enable_attach_ptr = ITTNOTIFY_NAME(enable_attach)

const __itt_module_loadA = ITTNOTIFY_VOID(module_loadA)

const __itt_module_load = __itt_module_loadA

const __itt_module_loadA_ptr = ITTNOTIFY_NAME(module_loadA)

const __itt_module_load_ptr = __itt_module_loadA_ptr

const __itt_module_loadW = ITTNOTIFY_VOID(module_loadW)

const __itt_module_loadW_ptr = ITTNOTIFY_NAME(module_loadW)
...
const __itt_histogram_createA = ITTNOTIFY_DATA(histogram_createA)

const __itt_histogram_create = __itt_histogram_createA

const __itt_histogram_createA_ptr = ITTNOTIFY_NAME(histogram_createA)

const __itt_histogram_create_ptr = __itt_histogram_createA_ptr

const __itt_histogram_createW = ITTNOTIFY_DATA(histogram_createW)

const __itt_histogram_createW_ptr = ITTNOTIFY_NAME(histogram_createW)
...
const __itt_counter_createA_v3 = ITTNOTIFY_DATA(counter_createA_v3)

const __itt_counter_create_v3 = __itt_counter_createA_v3

const __itt_counter_createA_v3_ptr = ITTNOTIFY_NAME(counter_createA_v3)

const __itt_counter_create_v3_ptr = __itt_counter_createA_v3_ptr

const __itt_counter_createW_v3 = ITTNOTIFY_DATA(counter_createW_v3)

const __itt_counter_createW_v3_ptr = ITTNOTIFY_NAME(counter_createW_v3)
